...
from f.information_extraction.utils import (
    extract_json,
...
from f.information_extraction.schema_loader import get_schema
...
def step_build_prompt(
    ...
    return build_prompt(ocr_text, prompt_path)
...
def step_validate_schema(data: Dict[str, Any], doc_type: str) -> Dict[str, Any]:
    """Bước 5: Tải schema tương ứng để kiểm tra."""
...
def run_base_extraction(
    ...
    prompt = step_build_prompt(ocr_text=None, prompt_path=prompt_path)
